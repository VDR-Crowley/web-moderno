...
Outra coisa importante de observar, é o fato que o ponto 
é utilizado no lugar da vírgula e vice versa. 
...
function setMoney(dinheiro) {
  return `${dinheiro.toLocaleString('pt-br', {style: 'currency', currency: 'BRL'})}`;
}

console.log(setMoney(0.3000000000000004));